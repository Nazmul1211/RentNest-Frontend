...
export default function NotFound() {
  return (
    <div className="min-h-[calc(100vh-140px)] bg-background relative flex items-center justify-center p-4 sm:p-6 lg:p-8 overflow-hidden my-auto">
      ...
      <div className="absolute bottom-1/3 left-1/3 w-72 h-72 bg-amber-500/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-xl w-full text-center space-y-6 z-10 my-auto">
        ...
        <div className="bg-card/90 backdrop-blur-xl border border-border/40 rounded-3xl p-8 sm:p-10 shadow-lg space-y-5">
          ...
          {/* Badge & Icon */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-teal-500/10 text-teal-600 text-xs font-bold border border-teal-500/20">
          ...
          <div className="space-y-2">
            <h1 className="text-6xl sm:text-7xl font-black tracking-tight bg-gradient-to-r from-teal-600 via-amber-600 to-teal-500 bg-clip-text text-transparent">
              404
            </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Button
              asChild
              className="w-full sm:w-auto bg-teal-600 hover:bg-teal-700 text-white font-bold px-6 py-2.5 rounded-xl text-xs shadow-xs"
            >
            ...
            >
              <Link href="/properties" className="flex items-center justify-center gap-2">
                <Building2 className="size-4 text-teal-600" /> Browse Properties
              </Link>
            </Button>
          </div>
