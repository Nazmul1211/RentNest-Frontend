      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <section className="flex-1 w-full space-y-8">
          <div className="space-y-1">
            <h3 className="text-xl font-bold text-foreground">Landlord Workspace</h3>
            <p className="text-xs text-muted-foreground">Manage your property listings, tenant rental applications, and active leases.</p>
          </div>

          <div className="space-y-4">
            <h4 className="text-base font-bold text-foreground">Landlord Actions</h4>
