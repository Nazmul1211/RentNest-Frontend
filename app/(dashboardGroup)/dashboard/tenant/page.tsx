      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <section className="w-full lg:w-80 p-6 space-y-4 bg-card rounded-2xl shadow-sm border border-border/50 shrink-0">
          <div className="space-y-1">
            ...
            <span className="inline-block mt-2 px-2.5 py-0.5 text-xs font-semibold rounded-full bg-cyan-500/10 text-cyan-700 capitalize">
        ...
        <section className="flex-1 w-full space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-card rounded-2xl border border-border/50 p-6 space-y-4 flex flex-col justify-between hover:border-cyan-500/40 hover:shadow-xs transition-all">
              ...
              <Button asChild className="w-full bg-cyan-600 hover:bg-cyan-700 text-white font-semibold text-xs">
          ...
          <div className="bg-card rounded-2xl mt-16 space-y-4 shadow-xs">
            <div className="flex items-center justify-between pb-3">
              ...
              <Button variant="outline" size="sm" className="text-xs font-semibold text-cyan-600 border-cyan-500/30" asChild>
