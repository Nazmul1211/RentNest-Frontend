        ...
        <div className="space-y-4 my-4">
            {properties.map((property: any) => {
                ...
                return (
                    <div
                        key={property.id}
                        className="p-4 rounded-xl border border-border/50 bg-card hover:border-cyan-500/30 transition-all shadow-xs space-y-3"
                    >
                            ...
                            <div className="flex-1 space-y-1.5 w-full">
                                ...
                                <div className="flex items-center gap-3 pt-2 text-[11px] text-muted-foreground border-t border-border/30">
                                    <span className="flex items-center gap-1">
                                        <Bed className="size-3 text-cyan-600" /> {property.bedrooms} Beds
                                    </span>
                                    <span className="flex items-center gap-1">
                                        <Bath className="size-3 text-cyan-600" /> {property.bathrooms} Baths
                                    </span>
                                    <span className="flex items-center gap-1">
                                        <Ruler className="size-3 text-cyan-600" /> {property.sizeSqft} sqft
                                    </span>
                                </div>
                            </div>
                        </div>
