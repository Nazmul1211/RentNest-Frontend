        ...
        <>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
                    <div className="bg-white dark:bg-[#182630] border border-slate-200 dark:border-slate-800 rounded-xl shadow-2xl w-full max-w-sm p-6 space-y-4 text-slate-900 dark:text-slate-100">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-1.5">
                                <label htmlFor="status-select" className="text-xs font-semibold text-slate-700 dark:text-slate-300 block">
                                    Select New Status
                                </label>
                                <select
                                    id="status-select"
